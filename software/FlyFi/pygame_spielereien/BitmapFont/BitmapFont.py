...
class BitmapFontScroller:
    def __init__(self, target_surface, font_path, x_pos, y_pos):
        ...
        self.backbuffer_surface = pygame.Surface((self.scroller_surface.get_width(),
                                              self.scroller_surface.get_height()))

        self.backbuffer_surface.set_colorkey(pygame.Color(0,0,0))
    ...
    def scroll(self, pixels_per_second):
        ...
        while pixel_underflow == 0:
            ...
            self.backbuffer_surface.blit(self.scroller_surface, (self.x_pos, self.y_pos))
            ...
            self.backbuffer_surface.blit(self.effect_surface, (0, 0))
            self.target_surface.blit(self.backbuffer_surface, (self.x_pos, self.y_pos))
